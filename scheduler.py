...
schedule.every().tuesday.at("10:00").do(create_article_post)
schedule.every().tuesday.at("17:00").do(create_and_post)
schedule.every().wednesday.at("09:00").do(create_and_post)
schedule.every().wednesday.at("17:00").do(create_and_post)
schedule.every().thursday.at("09:00").do(create_and_post)
schedule.every().thursday.at("10:00").do(create_article_post)
schedule.every().thursday.at("17:00").do(create_and_post)
schedule.every().friday.at("09:00").do(create_and_post)
schedule.every().friday.at("17:00").do(create_and_post)
schedule.every().saturday.at("09:00").do(create_and_post)
schedule.every().sunday.at("18:00").do(create_and_post)
